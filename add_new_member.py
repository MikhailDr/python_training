...
class add_new_member(unittest.TestCase):
    ...
    def test_add_new_member(self):
        ...
        self.create_new_member(wd, firstname="Mike", middlename="Sedrick", lastname="Dashman", nickname="Miki", title="Finger", company="MIT", address="CA, Los Altos, 24", home="none",
                               ...
                               annyday="//div[@id='content']/form/select[3]//option[20]",
    ...
    def create_new_member(self, wd, firstname, middlename, lastname, nickname, title, company, address, home, mobile,
                          workphone, fax, email, email2, email3, homepage, birthday, birthmonth, birthyear, annyday,
        ...
        if not wd.find_element_by_xpath("//div[@id='content']/form/select[3]//option[20]").is_selected():
            wd.find_element_by_xpath(annyday).click()
        if not wd.find_element_by_xpath("//div[@id='content']/form/select[4]//option[6]").is_selected():
            wd.find_element_by_xpath(annimonth).click()
        wd.find_element_by_name("ayear").click()
        wd.find_element_by_name("ayear").clear()
        wd.find_element_by_name("ayear").send_keys(anniyear)
