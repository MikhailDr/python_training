...
def test_add_new_contact(app):
    ...
    app.create_new_contact(Contacts(firstname="Mike", middlename="Sedrick", lastname="Dashman", nickname="Miki", title="Finger", company="MIT", address="CA, Los Altos, 24", home="none",
